...
const RegUsers = () => {
    ...
    const url = "http://localhost/kodego/jjc/users.php";
        ...
        <div className='m-auto p-4 text-center'> 
            <div className='row'>
                ...
                <div className='col-md-4 m-5'>
                    ...
                    <form>
                        Name: <br></br>
                        <input type='text' id='name' name='name' value={name} onChange={(e) => setName(e.target.value)} className='form-control' required/><br></br>
                        Email: <br></br>
                        <input type='email' id='email' name='email' value={email} onChange={(e) => setEmail(e.target.value)} className='form-control' required /><br></br>
                        Password: <br></br>
